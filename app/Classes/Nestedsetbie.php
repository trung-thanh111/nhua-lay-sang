...
class Nestedsetbie{
	...
	public function Get(){
        ...
        $parentColumn = Schema::hasColumn($this->params['table'], 'parent_id') ? 'tb1.parent_id' : 'tb1.parentid';
		$result = DB::table($this->params['table'].' as tb1')
		->select('tb1.id','tb2.name', DB::raw($parentColumn.' as parent_id'),'tb1.lft','tb1.rgt','tb1.level','tb1.order')
